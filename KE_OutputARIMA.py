...
arima_distance = calculate_distance(train_selling, arima_cut)
arima_accuracy = calculate_accuracy(train_selling, arima_cut)

print("ARIMA Model:")
print("MSE:", arima_distance['mse'])
print("RMSE:", arima_distance['rmse'])
print("R2:", arima_accuracy['r2'])
print("Pearson:", arima_accuracy['pearson'])
print("Spearman:", arima_accuracy['spearman'])
